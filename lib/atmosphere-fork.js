...
(function (root, factory) {
    ...
    atmosphere = {
        ...
        AtmosphereRequest: function (options) {
            ...
            /**
             * {boolean} If self beforeUnload event has been called.
            ...
            function _clearStorage() {
                ...
                if (_storageService != null) {
                    ...
                    // Removes the trace
                    self.cookie = _sharingKey + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";
            ...
            function _supportWebsocket() {
                return _request.webSocketImpl != null || self.WebSocket || self.MozWebSocket;
            }
            ...
            function _supportSSE() {
                ...
                var crossOrigin = !!(parts && (
                    // protocol
                    parts[1] != self.location.protocol ||
                    // hostname
                    parts[2] != self.location.hostname ||
                    // port
                    (parts[3] || (parts[1] === "http:" ? 80 : 443)) != (self.location.port || (self.location.protocol === "http:" ? 80 : 443))
                ));
                return self.EventSource && (!crossOrigin || !atmosphere.util.browser.safari || atmosphere.util.browser.vmajor >= 7);
            }
            ...
            function _local(request) {
                var trace, connector, orphan, name = "atmosphere-" + request.url, connectors = {
                    storage: function () {
                        ...
                        return {
                            init: function () {
                                ...
                                atmosphere.util.on(self, "storage", onstorage);
                                return get("opened");
                            },
                            ...
                            close: function () {
                                ...
                                atmosphere.util.off(self, "storage", onstorage);
                                if (children) {
                    ...
                    windowref: function () {
                        var win = self.open("", name.replace(/\W/g, ""));
                ...
                function findTrace() {
                    var matcher = new RegExp("(?:^|; )(" + encodeURIComponent(name) + ")=([^;]*)").exec(self.cookie);
                    if (matcher) {
            ...
            function share() {
                var storageService, name = "atmosphere-" + _request.url, servers = {
                    ...
                    // Powered by the self.open method
                    // https://developer.mozilla.org/en/DOM/self.open
                    windowref: function () {
                        // Internet Explorer raises an invalid argument error
                        // when calling the self.open method with the name containing non-word characters
                        var neim = name.replace(/\W/g, ""), container = self.getElementById(neim), win;
                        ...
                        return {
                            init: function () {
                                ...
                                // In IE 8 and less, only string argument can be safely passed to the function in other self
                ...
                _jqxhr = {
                    open: function () {
                        ...
                        function poll() {
                            ...
                            var head = self.head || self.getElementsByTagName("head")[0] || self.documentElement;
            ...
            function _executeSSE(sseOpened) {
                ...
                _sse.onmessage = function (message) {
                    ...
                    if (!_request.enableXDR && self.location.host && message.origin && message.origin !== self.location.protocol + "//" + self.location.host) {
                        atmosphere.util.log(_request.logLevel, ["Origin was not " + self.location.protocol + "//" + self.location.host]);
                        return;
                    }
            ...
            function _executeRequest(request) {
                ...
                if (atmosphere.util.browser.msie && +atmosphere.util.browser.version.split(".")[0] < 10) {
                    if ((rq.transport === 'streaming')) {
                        if (rq.enableXDR && self.XDomainRequest) {
                            _ieXDR(rq);
                        } else {
                            _ieStreaming(rq);
                        }
            ...
            function _configureXDR(request) {
                ...
                var lastIndex = 0;
                var xdr = new self.XDomainRequest();
                ...
                var rewriteURL = rq.rewriteURL || function (url) {
                    ...
                    var match = /(?:^|;\s*)(JSESSIONID|PHPSESSID)=([^;]*)/.exec(self.cookie);
            ...
            function _configureIE(request) {
                ...
                return {
                    open: function () {
                        ...
                        var cdoc = iframe.contentDocument || iframe.contentself.self;
                        ...
                        stop = atmosphere.util.iterate(function () {
                            try {
                                ...
                                if (!cdoc.body || !cdoc.body.firstChild || cdoc.body.firstChild.nodeName.toLowerCase() !== "pre") {
                                    ...
                                    script.text = "self.write('<plaintext>')";
    ...
    atmosphere.util = {
        ...
        getAbsoluteURL: function (url) {
            if (typeof (self.createElement) === 'undefined') {
        ...
        storage: function () {
            try {
                return !!(self.localStorage && self.StorageEvent);
            } catch (e) {
        ...
        iterate: function (fn, interval) {
            ...
            // For detail, see https://developer.mozilla.org/en/self.setTimeout#Minimum_delay_and_timeout_nesting
            interval = interval || 0;
        ...
        checkCORSSupport: function () {
            if (atmosphere.util.browser.msie && !self.XDomainRequest && +atmosphere.util.browser.version.split(".")[0] < 11) {
                return true;
    ...
    atmosphere.bindEvents = function () {
        atmosphere.util.on(self, "unload", atmosphere.callbacks.unload);
        atmosphere.util.on(self, "beforeunload", atmosphere.callbacks.beforeUnload);
        atmosphere.util.on(self, "offline", atmosphere.callbacks.offline);
        atmosphere.util.on(self, "online", atmosphere.callbacks.online);
    };

    atmosphere.unbindEvents = function () {
        atmosphere.util.off(self, "unload", atmosphere.callbacks.unload);
        atmosphere.util.off(self, "beforeunload", atmosphere.callbacks.beforeUnload);
        atmosphere.util.off(self, "offline", atmosphere.callbacks.offline);
        atmosphere.util.off(self, "online", atmosphere.callbacks.online);
    };
